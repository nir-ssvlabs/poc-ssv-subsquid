module.exports = class Data1730297040346 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "network" text NOT NULL, "version" text NOT NULL, "log_index" numeric NOT NULL, "transaction_hash" text NOT NULL, "transaction_index" numeric NOT NULL, "event" text NOT NULL, "block_number" numeric NOT NULL, "owner_address" text, "raw_data" text NOT NULL, "created_at" numeric NOT NULL, "processed" numeric, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
    }
