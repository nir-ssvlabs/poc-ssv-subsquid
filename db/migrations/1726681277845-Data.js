module.exports = class Data1726681277845 {
    name = 'Data1726681277845'

    async up(db) {
        await db.query(`CREATE TABLE "validator" ("id" character varying NOT NULL, "network" text NOT NULL, "version" text NOT NULL, "owner_address" text NOT NULL, "public_key" text NOT NULL, "operators" bigint array NOT NULL, "cluster" text NOT NULL, "shares" text NOT NULL, "shares_public_keys" text array NOT NULL, "encrypted_keys" text array NOT NULL, "block_number" numeric NOT NULL, "log_index" numeric NOT NULL, "transaction_index" numeric NOT NULL, "added_at_block_number" numeric NOT NULL, "added_at_log_index" numeric NOT NULL, "added_at_transaction_index" numeric NOT NULL, "is_valid" boolean NOT NULL, "is_deleted" boolean NOT NULL, "is_liquidated" boolean NOT NULL, "ignore_on_sync" boolean NOT NULL, "created_at" numeric NOT NULL, "updated_at" numeric NOT NULL, "is_draft" boolean NOT NULL, "is_public_key_valid" boolean NOT NULL, "is_shares_valid" boolean NOT NULL, "is_operators_valid" boolean NOT NULL, "memo" text array, CONSTRAINT "PK_ae0a943022c24bd60e7161e0fad" PRIMARY KEY ("id"))`)
